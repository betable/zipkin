...
object Span extends ThriftStructCodec3[Span] {
  ...
  def unapply(_item: Span): _root_.scala.Option[scala.Product7[Long, String, Long, Option[Long], Seq[com.twitter.zipkin.thriftscala.Annotation], Seq[com.twitter.zipkin.thriftscala.BinaryAnnotation], Boolean]] = _root_.scala.Some(_item)
...
trait Span
  ...
  with scala.Product7[Long, String, Long, Option[Long], Seq[com.twitter.zipkin.thriftscala.Annotation], Seq[com.twitter.zipkin.thriftscala.BinaryAnnotation], Boolean]
