...
trait DependencyStore[+MM[_]] extends ThriftService {
...
object DependencyStore { self =>
  ...
  implicit object MethodIfaceBuilder
    extends com.twitter.finagle.thrift.MethodIfaceBuilder[ServiceIface, DependencyStore[Future]] {
    def newMethodIface(serviceIface: ServiceIface): DependencyStore[Future] =
  ...
  object StoreDependencies extends com.twitter.scrooge.ThriftMethod {
    ...
    val serviceName = "DependencyStore"
    val argsCodec = Args
  ...
  trait FutureIface extends DependencyStore[Future] {
  ...
  class FinagledClient(
      ...
      serviceName: String = "DependencyStore",
      stats: com.twitter.finagle.stats.StatsReceiver = com.twitter.finagle.stats.NullStatsReceiver)
    extends DependencyStore$FinagleClient(
      service,
      protocolFactory,
      serviceName,
      stats)
  ...
  class FinagledService(
    ...
    extends DependencyStore$FinagleService(
      iface,
      protocolFactory)
}