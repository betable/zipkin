...
object Dependencies extends ThriftStructCodec3[Dependencies] {
          ...
          case 2 =>
            _field.`type` match {
              case TType.I64 =>
                ...
                endTime = readEndTimeValue(_iprot)
              case _actualType =>
                val _expectedType = TType.I64
                throw new TProtocolException(
  ...
  trait Proxy extends Dependencies {
    ...
    override def startTime: Long = _underlying_Dependencies.startTime
    override def endTime: Long = _underlying_Dependencies.endTime
  ...
  with java.io.Serializable
{
          ...
          _fieldId match {
            case 1 =>
              if (true) {
                ...
                _root_.scala.Some(Dependencies.StartTimeField)
              } else {
                _root_.scala.None
              }
            case 2 =>
              if (true) {
                writeEndTimeValue(endTime, _oprot)
                _root_.scala.Some(Dependencies.EndTimeField)
              } else {
                _root_.scala.None
              }
            case 3 =>
  ...
  def setField(_blob: TFieldBlob): Dependencies = {
    ...
    _blob.id match {
      ...
      case 2 =>
        endTime = readEndTimeValue(_blob.read)
      case 3 =>
   ...
   * from the passthroughFields map, if present.
   */
  def unsetStartTime: Dependencies = unsetField(1)

  def unsetEndTime: Dependencies = unsetField(2)
  ...
  override def write(_oprot: TProtocol): Unit = {
    ...
    writeEndTimeField(endTime, _oprot)
