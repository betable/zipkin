...
object Annotation extends ThriftStructCodec3[Annotation] {
  ...
  val DurationFieldManifest = implicitly[Manifest[Int]]
      ...
      if (_field.`type` == TType.STOP) {
        ...
        _field.id match {
          ...
          case 4 =>
            _field.`type` match {
              case TType.I32 =>
                durationOffset = _iprot.offsetSkipI32
  ...
  private[this] def eagerDecode(_iprot: TProtocol): Annotation = {
    ...
    var duration: _root_.scala.Option[Int] = _root_.scala.None
    var _passthroughFields: Builder[(Short, TFieldBlob), immutable$Map[Short, TFieldBlob]] = null
    var _done = false
  ...
  def apply(
    ...
    duration: _root_.scala.Option[Int] = _root_.scala.None
  ): Annotation =
    new Immutable(
      timestamp,
      value,
  ...
  def unapply(_item: Annotation): _root_.scala.Option[scala.Product4[Long, String, Option[com.twitter.zipkin.thriftscala.Endpoint], Option[Int]]] = _root_.scala.Some(_item)
  ...
  @inline private def readDurationValue(_iprot: TProtocol): Int = {
    _iprot.readI32()
  }

  @inline private def writeDurationField(duration_item: Int, _oprot: TProtocol): Unit = {
    _oprot.writeFieldBegin(DurationField)
    writeDurationValue(duration_item, _oprot)
    _oprot.writeFieldEnd()
  }

  @inline private def writeDurationValue(duration_item: Int, _oprot: TProtocol): Unit = {
  ...
  class Immutable(
      ...
      val duration: _root_.scala.Option[Int],
  ...
  private[this] class LazyImmutable(
    ...
    lazy val duration: _root_.scala.Option[Int] =
      if (durationOffset == -1)
        None
      else {
        Some(_proto.decodeI32(_buf, durationOffset))
      }
  ...
  trait Proxy extends Annotation {
    ...
    override def duration: _root_.scala.Option[Int] = _underlying_Annotation.duration
...
trait Annotation
  ...
  with scala.Product4[Long, String, Option[com.twitter.zipkin.thriftscala.Endpoint], Option[Int]]
  with java.io.Serializable
{
  ...
  def duration: _root_.scala.Option[Int]
          ...
          _fieldId match {
            ...
            case 4 =>
              if (duration.isDefined) {
                ...
                _root_.scala.Some(Annotation.DurationField)
              } else {
                _root_.scala.None
              }
  ...
  def setField(_blob: TFieldBlob): Annotation = {
    ...
    var duration: _root_.scala.Option[Int] = this.duration
  ...
  def unsetDuration: Annotation = unsetField(4)
  ...
  def copy(
    ...
    duration: _root_.scala.Option[Int] = this.duration,
